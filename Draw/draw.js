...
function drawParallelRight(){
    ...
    for (var i=0; i < arguments.length - 1; i++) {
        context.lineTo(arguments[i].connections.end.x + parallelSpacingHorizontal, arguments[i].connections.end.y);
        context.lineTo(arguments[i].connections.end.x + parallelSpacingHorizontal, arguments[i].connections.end.y + parallelSpacingVertical);
        context.lineTo(arguments[i + 1].connections.end.x, arguments[i + 1].connections.end.y);
    }
    context.stroke();
}
